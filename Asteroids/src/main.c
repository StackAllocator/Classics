...
int main() {
  ...
  // ------------------------------------------------------
  // load music
  Music startMusic = LoadMusicStream("./Resources/Music/8-bit-arcade.mp3");
  Music playMusic = LoadMusicStream("./Resources/Music/legends.mp3");
  // ------------------------------------------------------
  ...
  Texture2D bullet = LoadTexture("./Resources/Assets/Airship.png"); // load bullet texture
